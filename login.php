...
<div class="container py-4 py-lg-5 my-4">
    <div class="row">
        ...
        <div class="col-md-6 pt-4 mt-3 mt-md-0">
            ...
            <form class="needs-validation" novalidate method="post" action="registration-logic.php">
                <div class="row gx-4 gy-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input class="form-control" type="password" name="password_1" required id="reg-password-confirm">
